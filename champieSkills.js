    ...
    setTimeout(event => {
        ...
        setTimeout(event => {
            ...
            setTimeout(event => {
                ...
                let poise_meterInside = document.createElement("div")
                poise_meterInside.id = "poise_meterInside"

                document.getElementById("poise_panel").innerHTML += `<div><div id="poise_meterInside"></div></div>`
